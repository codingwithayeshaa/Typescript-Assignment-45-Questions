...
//                  0       1       2      3
let guestList = ["Phillip","Erica","John","Lisa"];

//Creating a Guestlist array who can't come
let cannotCome = guestList[1];
...
guestList.forEach(guest => console.log(`Hello ${guest} Would you like to have dinner with us.`));
...
while(guestList.length > 2){
    ...
    console.log(`I'm sorry ${ removedGuests},I can't invite you to Dinner.`);
}

// Print a invitation message to the remaining last two guests 
console.log("Invitations to the last Two guests:");
guestList .forEach(lastTwoguests => console.log(`Luckily ${lastTwoguests} You're still invited to dinner.`));
